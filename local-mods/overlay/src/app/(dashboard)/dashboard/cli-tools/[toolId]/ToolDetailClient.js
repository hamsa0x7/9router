...
import {
  ...
  JcodeToolCard, LettaToolCard, OmpToolCard, PiToolCard,
} from "../components";
...
export default function ToolDetailClient({ toolId, machineId }) {
  ...
  const renderToolCard = () => {
    ...
    switch (toolId) {
      ...
      case "letta":
        return <LettaToolCard {...commonProps} activeProviders={getActiveProviders()} hasActiveProviders={hasActiveProviders} />;
      case "omp":
        return <OmpToolCard {...commonProps} activeProviders={getActiveProviders()} hasActiveProviders={hasActiveProviders} />;
      case "pi":
