...
`;
    ...
    return [
      { filename: "~/.codewhale/config.toml", content: tomlContent },
    ];
  };
              ...
              <div className="flex flex-col gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <code className="block mt-2 p-2 bg-black/20 rounded text-xs font-mono">npm install -g @codewhale/cli</code>
