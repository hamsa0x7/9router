...
async function openDashboardSmart(port, onOpenDashboard) {
  ...
  try {
    ...
    // If a dashboard SSE client is connected, the focus event was delivered.
    // The browser tab should activate via the SSE listener.
    // Only open a new browser tab if NO dashboard is connected.
